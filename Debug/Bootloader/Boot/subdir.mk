...
OBJS += \
./Bootloader/Boot/bootloader.o 

C_DEPS += \
./Bootloader/Boot/bootloader.d 


# Each subdirectory must supply rules for building sources it contributes
Bootloader/Boot/%.o Bootloader/Boot/%.su Bootloader/Boot/%.cyclo: ../Bootloader/Boot/%.c Bootloader/Boot/subdir.mk
...
clean: clean-Bootloader-2f-Boot

clean-Bootloader-2f-Boot:
	-$(RM) ./Bootloader/Boot/bootloader.cyclo ./Bootloader/Boot/bootloader.d ./Bootloader/Boot/bootloader.o ./Bootloader/Boot/bootloader.su

.PHONY: clean-Bootloader-2f-Boot
